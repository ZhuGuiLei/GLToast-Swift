...
public struct ToastStyle {
    ...
    /**
     背景色. Default is `.black` at 80% opacity.
    */
    public var backgroundColor: UIColor = UIColor.black.withAlphaComponent(0.8)
    
    /**
     标题色. Default is `UIColor.whiteColor()`.
    */
    public var titleColor: UIColor = .white
    
    /**
     内容色. Default is `.white`.
    */
    ...
    */
    ...
    /**
     标题字体. Default is `.boldSystemFont(15.0)`.
    */
    public var titleFont: UIFont = .boldSystemFont(ofSize: 15.0)
    
    /**
     信息字体. Default is `.systemFont(ofSize: 13.0)`.
    */
    ...
    */
    ...
    /**
     启用阴影. Default is `false`.
    */
    public var displayShadow = false
    
    /**
     阴影色. Default is `.black`.
     */
    public var shadowColor: UIColor = .black
    
    /**
     阴影的不透明度 0.0 to 1.0. Default is 0.8 (80% opacity).
    */
